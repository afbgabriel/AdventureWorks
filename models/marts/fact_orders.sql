with
    ...
    , orderheader_with_sk as (
        select
            ...
            -- status encontrado na documentação Adventure Works: https://dataedo.com/download/AdventureWorks.pdf
    ...
    , final as (
        select
            ...
            , orderheader_with_sk.firstname
            , orderheader_with_sk.lastname
        ...
        left join address1 on orderheader_with_sk.billtoaddressid = address1.addressid
